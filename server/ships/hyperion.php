...
class Hyperion extends Ship {
	...
	public function addStructures(){
		...
		$right = new Structure($this->getId(), $this->id, 30, 150, $this->mass, 60);
		...
		$left = new Structure($this->getId(), $this->id, 210, 330, $this->mass, 60);
	...
	public function addPrimary(){
		$this->primary = new Primary($this->getId(), $this->id, 0, 360, $this->mass, 70);
	}
}
