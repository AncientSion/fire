...
class Tinashi extends Medium {
	...
	public function addPrimary(){
		...
		$this->primary->systems[] = new Engine($this->getId(), $this->id, 110, 110);
		$this->primary->systems[] = new Lifesupport($this->getId(), $this->id, 110);
		$this->primary->systems[] = new Sensor($this->getId(), $this->id, 110, 900, 10);
		$this->primary->systems[] = new Reactor($this->getId(), $this->id, 110, $this->getPowerReq()+4);
	}
}
