...
class Sharlin extends UltraHeavy {
	...
	public function addStructures(){
		...
		$left = new Structure($this->getId(), $this->id, 240, 360, 2450, 32);
		...
		$right = new Structure($this->getId(), $this->id, 0, 120, 2450, 32);
		...
		$aft = new Structure($this->getId(), $this->id, 120, 240, 2100, 26);
			...
			$aft->systems[] = new Hangar($this->getId(), $this->id, 12, array("Nial"), 24);
			$aft->systems[] = new NeutronLaser($this->getId(), $this->id, 120, 240);
		$structs[] = $aft;
