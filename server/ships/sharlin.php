...
class Sharlin extends UltraHeavy {
	...
	public function addStructures(){
		...
		$left = new Structure($this->getId(), $this->id, 240, 360, 2450, 40);
		...
		$right = new Structure($this->getId(), $this->id, 0, 120, 2450, 40);
		...
		$aft = new Structure($this->getId(), $this->id, 120, 240, 2100, 35);
	...
	public function addPrimary(){
		...
		$this->primary->systems[] = new Sensor($this->getId(), $this->id, 250, 1300, 10);
		$this->primary->systems[] = new Reactor($this->getId(), $this->id, 250, $this->getPowerReq()+12);
	}
}
