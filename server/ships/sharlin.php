...
class Sharlin extends UltraHeavy {
	...
	public function addStructures(){
		...
		$left = new Structure($this->getId(), $this->id, 240, 360, 2450, 35);
		...
		$right = new Structure($this->getId(), $this->id, 0, 120, 2450, 35);
		...
		$aft = new Structure($this->getId(), $this->id, 120, 240, 2100, 28);
	...
	public function addPrimary(){
		...
		$this->primary->systems[] = new Reactor($this->getId(), $this->id, 225, $this->getPowerReq()+12);
	}
}
