...
Ship.prototype.doDeploy = function(pos){
	...
	if (this.actions.length){
		...
		this.actions.push(new Move(-1, this.id,  game.turn, "deploy", 0, 0, pos.x, pos.y, this.drawFacing, 0, 0, 0, 1, 1, 0));
		this.deployed = 1;
		this.isReady = 1;
		this.x = pos.x;
		this.y = pos.y;
