...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Sep 2017 um 16:26
...
(32, 9, 2, 'deploy', 0, 551, -346, 167, 0, 0, 1, 0);
...
(1, 1, 1, 2, -1, 'Earth Alliance', 468, 'waiting'),
(2, 2, 1, 2, -1, 'Narn Regime', 759, 'ready');
...
(9, 1, 2, 0, 0, 'Flight', 'deployed', 2, 0, 0, 0, 0, 0, 0, 0, 0);
